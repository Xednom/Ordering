"""
Django settings for systems project.
...
# STATICFILES_STORAGE = 'whitenoise.django.GzipManifestStaticFilesStorage' commented this out because heroku app returned a server error 500
